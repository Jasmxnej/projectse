      ...
      <div class="xl:col-span-2">
        <div class="bg-white rounded-xl shadow-lg p-6">
          ...
          <HotelSearchForm
            ...
            :initial-location="getHotelLocation()"
            :initial-city-code="getHotelCityCode()"
            :initial-guests="getHotelGuests()"
...
const getHotelLocation = () => {
  ...
  return tripStore.destination || '';
};

const getHotelCityCode = () => {
  if (tripStore.hotel) {
    return tripStore.hotel.cityCode || tripStore.hotel.city_code || tripStore.destinationIataCode || '';
  }
  return tripStore.destinationIataCode || '';
};

const getHotelGuests = () => {
  if (tripStore.hotel) {
    return tripStore.hotel.adults || tripStore.hotel.number_of_adults || tripStore.groupSize || 1;
  }
  return tripStore.groupSize || 1;
};
